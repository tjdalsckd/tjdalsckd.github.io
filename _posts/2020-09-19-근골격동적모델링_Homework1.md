...
10. 특정 포인트에 대한 (선)속도와 (선)가속도
   ...
   * $A^{*}$(A링크의 무게중심)에서의 속도와 가속도
       ...
       $=\rho_{A}\frac{d}{dt}(\dot{q}_1)\hat{a}_2+\rho_{A}\dot{q}_1\frac{d}{dt}(\hat{a}_2)$
       
       $=\rho_{A}\ddot{q}_1\hat{a}_2+\rho_{A}\dot{q}_1({}^{N}\vec{\omega}{}^{A}\times \hat{a}_2)$
       
       $=-\rho_{A}\dot{q}^{2}_1\hat{a}_1+\rho_{A}\ddot{q}_1\hat{a}_2 $
